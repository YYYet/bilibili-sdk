...
import com.bilisdk.service.web.entity.resp.verifyqrcodeinfo.VerifyQRcodeInfoResp;
import com.bilisdk.service.web.api.WebLoginApi;
import com.bilisdk.service.web.entity.resp.qrcodeinfo.QRcodeInfoResp;
...
public class WebLoginSdk extends WebLoginApi {
    ...
    public static void startWebLogin() throws Exception {
        ...
        com.bilisdk.service.web.entity.resp.qrcodeinfo.QRcodeInfoResp qRcode = webLoginSdk.getWebQRcode();
